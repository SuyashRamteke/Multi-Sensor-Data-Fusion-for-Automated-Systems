...
if nargin<1
  base_dir  = '/media/krish/1074034e-a89f-45f7-b4ba-868708f404291/data/training';
end
if nargin<2
  calib_dir = '/media/krish/1074034e-a89f-45f7-b4ba-868708f404291/data/training/calib';
end
cam       = 2; % 0-based index
frame     = 0; % 0-based index

% load calibration
calib = loadCalibrationCamToCam(fullfile(calib_dir,'000000.txt'));
